package stackandqueue;// JAVA program to convert infix to prefix
import java.util.*;
...
class GFG
{
    ...
    static String infixToPostfix(char[] infix1)
    {
        ...
        int l = infix.length();
        java.util.Stack<Character> char_stack = new java.util.Stack<>();
        String output="";
    ...
    static String infixToPrefix(char[] infix)
    {
        ...
        // Reverse infix
        String infix1 = new StringBuilder(String.valueOf(infix)).reverse().toString();
